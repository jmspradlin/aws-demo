module "vpc" {
  ...
  azs             =  var.availability_zone #["us-east-2a", "us-east-2b", "us-east-2c"]
  public_subnets  = var.subnet.public #["10.0.0.0/27", "10.0.0.32/27", "10.0.0.64/27"]
  private_subnets = var.subnet.private #["10.0.1.0/27", "10.0.1.32/27", "10.0.1.64/27"]
